...
def parse_option():
    ...
    parser.add_argument('--distill', type=str, default='kd', choices=['kd', 'hint', 'attention', 'similarity',
                                                                      'correlation', 'vid', 
                                                                      'crd', 'crd_hcl', 'crd_topk', 'crd_hardneg',
                                                                      'kdsvd', 'fsp',
    ...
    if opt.model_s in ['mobilenetv2_6_025', 'mobilenetv2_6_05', 'mobilenetv2_6_1', 'mobilenet_v2_half', 'ShuffleV1', 'ShuffleV2']:
...
def main():
    ...
    if opt.dataset == 'cifar100':
        if opt.distill in ['crd', 'crd_hcl', 'crd_topk', 'crd_hardneg']:
            if opt.upsample:
    ...
    elif opt.distill in ['crd', 'crd_hcl', 'crd_topk', 'crd_hardneg']:

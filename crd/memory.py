...
class ContrastMemoryModified(nn.Module):
    ...
    Memory buffer that supplies large amount of negative samples.
    """
    def __init__(self, inputSize, outputSize, K, T=0.07, momentum=0.5, num_clusters=64*32):
    ...
    def forward(self, v1, v2, y, idx=None):
        ...
        kmeans_v1 = faiss.Kmeans(d=inputSize, k=batchSize*32, gpu=True)
        kmeans_v2 = faiss.Kmeans(d=inputSize, k=batchSize*32, gpu=True)
        ...
        idx = torch.arange(batchSize * 32).cuda()
